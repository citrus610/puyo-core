...
FieldBit FieldBit::get_mask_pop()
{
    ...
    __m128i r = _mm_srli_si128(this->data, 2) & m12;
    __m128i l = _mm_slli_si128(this->data, 2) & m12;
    __m128i u = _mm_srli_epi16(this->data, 1) & m12;
    __m128i d = _mm_slli_epi16(this->data, 1) & m12;
